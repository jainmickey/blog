...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('post_post', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=300, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'post.post': {
            'Meta': {'ordering': "['date', 'title']", 'object_name': 'Post'},
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '300', 'blank': 'True'}),
